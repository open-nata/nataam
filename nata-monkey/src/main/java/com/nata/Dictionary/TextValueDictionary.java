...
public class TextValueDictionary {
	  ...
	  public static String getRandomValidValue(){
		  if(MIX_valid == null){
	  ...
	  public static String getRandomInValidValue()
	  {
	    if (MIX_invalid == null){
	  ...
	  public static String getRandomValidValue(String inputType){
	  ...
	  public static String getRandomInValidValue(String inputType){
		  if (inputType.equals("email")) {
	  ...
	  public static String getRandomValue(String[] paramArrayOfString){
